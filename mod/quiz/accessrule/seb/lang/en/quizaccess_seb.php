...
$string['disabledsettings_help'] = 'Safe Exam Browser quiz settings can\'t be changed if the quiz has an in progress attempt. To change a setting, all in progress quiz attempts must first be deleted.';
...
$string['settingsfrozen'] = 'Due to there being at least one in progress quiz attempt, the Safe Exam Browser settings cannot be updated.';
